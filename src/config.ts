export const config: IConfig = {
    ...
    // 一言 API 的 Get 参数请自行去 /src/views/PersonalDescription.vue 中修改（默认调用文学与哲学一言）
    hitokoto: '#HitokotoEnable#',
    // name 无实际意义，仅用于标识此行用于表示什么
    // 默认使用 fontawesome 图标库，此时 icon 处需要填入 fontawesome 图标库的类名
    ...
    navItems: [
        ...
        { name: '个人博客', link: 'https://blog.izako.cc/' }
    ]
}
